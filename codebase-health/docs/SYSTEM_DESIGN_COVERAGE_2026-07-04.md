...
Key artifacts: /Users/bailey/Developer/zero-trust-verification/CONTEXT.md (Verification Manifest / Config Profile / Vital definitions grounding §3); /Users/bailey/Developer/zero-trust-verification/codebase-health/docs/SPEC_1.4.0.md (wave template, word-key freeze, honesty clause, determinism sweep precedent); /Users/bailey/Developer/zero-trust-verification/codebase-health/docs/GAPS_SPEC.md:290-310 (miss-to-fixture extras pre-queuing four Pack-1 plants; the 17 agent-scored entries defining Wave-6 cost); /Users/bailey/Developer/zero-trust-verification/codebase-health/test-fixtures/EXPECTED_FINDINGS.yaml (the enforcement boundary every pack must land in at Wave 0).