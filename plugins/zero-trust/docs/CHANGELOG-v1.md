# Changelog — v1.x suite history

Suite-level release history for the v1.x line (the six-plugin era, before the
ADR 0025 single-plugin consolidation). Moved verbatim from the repo-root
`CHANGELOG.md` in Wave 2 of the 2026-07 consolidation; v2.x history lives at
the repo root. Format: [Keep a Changelog](https://keepachangelog.com/); the
suite tag is the release marker.
