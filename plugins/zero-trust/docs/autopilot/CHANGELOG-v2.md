# Changelog — autopilot v2.x history

Entries ≤2.4.0, moved verbatim from skills/autopilot/CHANGELOG.md per ADR 0031 (v1
precedent: docs/CHANGELOG-v1.md). `GAPS-xx` / M-x references inside are historical —
the GAPS register was deleted in the ADR 0025 Wave 2 sediment deletion.
